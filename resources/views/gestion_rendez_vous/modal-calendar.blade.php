    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="titleModal">Modal</h5>
            ...
            <div class="modal-body">
                ...
                <form id="formEvent">
                    ...
                    <div class="form-group row">
                        <label for="fast_events_id" class="col-sm-4 col-form-label">fast_events_id</label>
                        <div class="col-sm-8">
                            <input type="text" name="fast_events_id" class="form-control" id="fast_events_id">
                        </div>
                    </div>
